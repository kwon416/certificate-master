...
export default function ValueCard({ icon: Icon, result, how, proof, gradient }: ValueCardProps) {
  return (
    <Card
      ...
      className="group bg-card/50 border-border hover:border-emerald-500/30 transition-[box-shadow,border-color] duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/10"
    >
